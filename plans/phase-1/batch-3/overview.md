# Batch 3 — Sequence AST + Parser

Single task. Depends on T2 (preprocessor output types) and T3 (UmlSource,
DiagramPlugin interface). All of Batch 2 must be complete before starting.
