...
|----|-------------|-------|--------|-----------|------|
| T9 | Sequence renderer + plugin wiring | typescript-pro | `src/diagrams/sequence/renderer.ts`, `src/diagrams/sequence/index.ts`, `tests/unit/sequence/renderer.test.ts` | T4, T5, T7, T8 | [ ] |
