...
|----|-------------|-------|--------|---------|-----------|------|
| T8 | Register + delete + migrate | typescript-pro | `src/index.ts`, `src/core/block-extractor.ts`, `.claude/catalog.md` | `src/diagrams/component/**`, `src/diagrams/usecase/**`, `tests/unit/component/**`, `tests/unit/usecase/**`, `tests/integration/{component,usecase}.test.ts` | T7 | [ ] |
