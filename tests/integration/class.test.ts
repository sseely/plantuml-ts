...
describe.skip('render() — class diagram async API', () => {
...
describe.skip('renderSync() — class diagram sync API', () => {
...
describe.skip('renderAll() — class diagram multi-block', () => {
...
describe.skip('class fixture files', () => {
