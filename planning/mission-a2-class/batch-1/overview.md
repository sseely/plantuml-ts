...
|----|-------------|-------|--------|-----------|------|
| T1 | Diagnose edge-topology divergence (feeds T5) | debugger | `../decision-journal.md` | — | [ ] |
| T2 | Pin 9 baseline class goldens + wire ratchet | typescript-pro | `oracle/goldens/class/**`, `tests/oracle/class-dot-parity.test.ts` | — | [ ] |
| T3 | Class HTML compartment-label builder | typescript-pro | `src/diagrams/class/class-html-label.ts`, `tests/unit/class/class-html-label.test.ts` | — | [ ] |
