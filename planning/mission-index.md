...
|----|---------|--------|-----------|----------|-------|
| S1 | text-measurement fidelity strategy | spike | — | decision recorded in an ADR: LUT vs Java-tables vs tolerance-band; measurement path chosen | Caps depth on EVERY type; do before deep per-type fidelity |
