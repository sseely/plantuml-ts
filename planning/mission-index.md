...
| G2 | class SVG conformance | in-progress (started 2026-07-15, maintainer "Go") | G1 (done) | 100% conformant minus known divergences (ruling 2026-07-14) — `plans/g2-class-svg/` (branch `feat/g2-class-svg`); raw baseline 0/718 conformant, 548 in the 4-10 bucket (few universal mechanisms suspected), 31 errors to triage |
