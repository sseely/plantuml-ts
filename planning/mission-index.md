...
| G1b | ink-extent margin + FrontierCalculator subsystem ("match the Java" — maintainer 2026-07-15) | in-progress | G1 (done) | the G1b-attributed fixture set (ink-extent ~23 named + ~40 topmost/leftmost cascades; FrontierCalculator 4+; most of I8's polygon + I9's deferred path families cascade) conformant or re-attributed, refreshed residue accounting — `plans/g1b-ink-extent/` (branch `feat/g1b-ink-extent`) |
