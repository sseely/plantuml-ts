...
| E2 | full Creole + sprite registry (Phase 4h) | todo (sprite/img HALF done in SI5b 2026-07-14: `<img:>`, `<$sprite>`, registry, measurement, SVG emission; residual: `<size:>`, `<back:>`, `<U+NNNN>`, nested markup) | SI5b (done) | `<size:>`,`<img:>`,`<$sprite>`,`<U+NNNN>`,`<back:>`,nested markup render (sprite registry needs the bundled-asset ruling; the non-sprite creole markup does not) |
