# Batch 2 — Primitive shapes

Single task. The `UShape` data classes every driver serializes. Depends only
on T2's marker interfaces.
...
## Next
Mark T3 `[x]`, commit, proceed to Batch 3.
