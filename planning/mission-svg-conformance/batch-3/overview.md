...
|----|--------------|-------|--------|------------|------|
| T4 | Port XmlWriter/Xml* + SvgGraphics (split per D2′) | typescript-pro (sonnet) | src/core/klimt/drawing/svg/{xml-writer,svg-graphics,svg-graphics-*}.ts, tests/unit/core/klimt/svg-graphics.test.ts | T2, T3 | [ ] |
